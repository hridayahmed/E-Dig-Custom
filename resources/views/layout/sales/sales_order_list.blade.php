        ...
        <div class="offset-lg-1 col-lg-10">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Product Sales List</h6>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @if(!empty($sales_order_data))
                                @forelse($sales_order_data as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm"><a href="{{ url('sales_order_details_show/'.$data->sales_order_id) }}"> Details </a></button>
                                        </td>
                                    </tr>
